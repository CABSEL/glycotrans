...
train_file = 'full_tensor.pt'          # Specify the path where full_tensor.pt file was saved from PrepareTensors.ipynb
train_tensor = torch.load(train_file)

labels_file = 'label.pkl'              # Specify the path where label.pkl file was saved from GenerateMSCorpus.ipynb
