...
from glycotrans.MSTokenizer import GlycanTranslationData
...
output_corpus_path = 'output_corpus.pt'            # Specify the path where output_corpus.pt file was saved from PrepareTensors.ipynb
